...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="presentation/yassine/images/icons/favicon.ico"/>
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="Inscription" method="post">
					<span class="login100-form-title p-b-43">
						Inscriver vous sur E-Colocation pour profiter de tous nous services
					</span>
					
                    <div class="form-group">
                        <input class="form-control" type="radio" name="statut" value="demandeur">Demandeur 
                        <input class="form-control" type="radio" name="statut" value="offreur">offreur
                    </div>
                    <br>
